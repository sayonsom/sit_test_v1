...
import { ChevronRightIcon, TicketIcon, BellIcon, UserIcon } from '@heroicons/react/20/solid'
...
export default function TechSupport() {
    ...
    const links = [
      ...
      },
      {
        ...
        href: 'https://plexflo.com/try',
        description: 'Do you want to do something that you can’t do in in the app? Let us know and we can build that for you.',
        icon: BellIcon,
      },
        {
        ...
        { name: 'Knowledge Base', href: 'https://docs.evidencemaestro.com', description: 'A complete API reference for our libraries.', icon: QueueListIcon }
      ]
    ...
    return (
        ...
        <div className="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
          <p className="text-base font-semibold leading-8 text-red-600">Trial Version</p>
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl font-heading">Tech Support</h1>
          <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-6 sm:text-lg sm:leading-8">
            For fastest response to any questions, comments, or concerns, please reach out to us at <a href="mailto:support@plexflo.com">support@plexflo.com</a>
          </p>
        </div>
